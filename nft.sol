...
contract CandyboxNFT is ERC721Enumerable {
  /**
    @dev A directory of a project's current Candybox terminal to receive payments in.
    */
  ...
  */
   ...
   * @param _memo A memo to send along with the payment that'll get emitted in the Candybox event.
   */
  function mint(
    address _to,
    uint256 _tokenId,
    ...
    // Get a reference to the Candybox terminal being used for the project.
